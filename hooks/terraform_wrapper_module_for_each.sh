...
terraform {
  ...
  # Alternative source:
  # source = "git::git@github.com:MODULE_REPO_ORG/REDACTED.git//WRAPPER_PATH?ref=master"
}
  ...
  for module_dir in "${all_module_dirs[@]}"; do
    ...
    for module_var in "${module_vars[@]}"; do
      ...
      if [[ ! $var_default ]]; then
        ...
        # https://github.com/terraform-aws-modules/terraform-aws-security-group/blob/REDACTED/rules.tf#L8
