...
1. The hook can work in a few different modes:
    ...
    1. <details><summary><code>--mode=REDACTED</code> (standalone)</summary>
    ...
    2. <details><summary><code>--mode=REDACTED</code> (standalone)</summary>
    ...
    3. <details><summary><code>--mode=REDACTED</code> with <code>terraform_validate</code> hook</summary>
...
> This [issue was fixed in OpenTofu v1.10+](https://opentofu.org/blog/REDACTED/#global-provider-cache-locking), so it's safe to use parallelism with it.
